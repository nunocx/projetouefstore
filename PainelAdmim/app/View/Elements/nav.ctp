		...
		<?php if(AuthComponent::user('id')){?>
			<ul class="nav navbar-nav side-nav">
				<li class="<?php echo $this->params->params['controller'] == 'pages' ? 'active' : ''?>">
                    ...
                    <li>
                        <a href="<?php echo $this->Html->url('/usuarios');?>"><i class="glyphicon glyphicon-search"></i> Buscar Usuarios </a>
                    </li>
                    <li>
                        <a href="<?php echo $this->Html->url('/mensagems');?>"><i class="glyphicon glyphicon-envelope"></i> Mensagens</a>
                    </li>


				<li class="dropdown <?php echo $this->params->params['controller'] == 'users' ? 'active' : ''?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> Admins <b
							class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo $this->params->webroot?>users"><i class="fa fa-list"></i> Lista</a></li>
						<li><a href="<?php echo $this->params->webroot?>users/add"><i class="fa fa-plus"></i> Cadastrar Admin</a></li>
					</ul>
				</li>
