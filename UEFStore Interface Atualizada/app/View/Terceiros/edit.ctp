...
<?php echo $this->Form->create('Terceiro'); ?>
	<fieldset>
		<legend><?php echo __('Edit Terceiro'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Terceiro.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Terceiro.id'))); ?></li>
