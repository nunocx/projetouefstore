...
.header {
	background: -webkit-linear-gradient(left, #009999 , #006699);
	padding:20px 0;
}
.header_top {
	padding-bottom: 0px;
...
.navigation span.left-ribbon{
	...
	width: 40px;
	height:60px;
	background: url(../img/images/left-fold.png) no-repeat;
	}
.navigation span.right-ribbon{
	...
	width: 40px;
	height:60px;
	background: url(../img/images/right-fold.png) no-repeat;
}
...
.nav > li {
    background-image: url("../img/images/line-divider.png");
...
@media screen and (max-width: 768px) {
    ...
    .nav li li .parent {
        background-image: url("/img/images/downArrow.png");
        background-repeat: no-repeat;
        background-position: 95% 50%;
    }
    .nav ul {
   ...
   .nav > li.hover > ul , .nav li li.hover ul {
    ...
    .nav > li {
    	 background-image: url("../img/images/nav-arrow.png");
...
.ocarousel span a.prev,.ocarousel span a.next{
	...
	height:30px;
	text-align:center;
	background: #009999 url("../img/images/arrows.png") no-repeat;
	border-radius:2em;
...
.categories li a{
	...
	padding:10px 15px;
    color: #9C9C9C;
    background:url(../img/images/drop_arrow.png) no-repeat 0;
...
.add-banner2{
	background:url("../img/images/banner-bg.png") repeat-x;
}
.add-banner2 h4{
	color:#23272a;
}
...
#toTop {
	...
	border: none;
	text-indent: 100%;
	background: url(../img/images/arrow_up.png) no-repeat right top;
}
