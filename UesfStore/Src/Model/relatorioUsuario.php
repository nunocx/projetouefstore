<?php
	...
	*/
	class RelatorioUsuario extends Relatorio
	{
		...
		public function __construct($titulo,$corpo,$imagem,$quantidadeUsuarios,$quantidadeUsuarioAdvertidos,$quantidadeUsuarioBloqueados,$quantidadeUsuariosDenunciados)
		{
