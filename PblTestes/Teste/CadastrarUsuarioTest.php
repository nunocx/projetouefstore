...
require_once dirname(__FILE__).'/../../PBLTestes/Exception/EmailInvalidoException.php';
require_once dirname(__FILE__).'/../../PBLTestes/Exception/CampoPreenchidoErradoException.php';
require_once dirname(__FILE__).'/../../PBLTestes/Exception/SenhaConfirmacaoErradaException.php';
require_once dirname(__FILE__).'/../../PBLTestes/Exception/UsuarioJaCadastradoException.php';
class CadastrarUsuarioTest extends PHPUnit_Framework_TestCase {
     ...
     * @expectedException SenhaConfirmaçãoErradaException 
     */
